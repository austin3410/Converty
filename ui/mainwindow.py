...
class Ui_Converty(object):
    def setupUi(self, Converty):
        ...
        self.gridLayout.addWidget(self.setOutput, 10, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.listWidget, 2, 0, 9, 4)
        ...
        self.gridLayout.addWidget(self.loadFile, 3, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.loadFolder, 2, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.convert, 13, 5, 1, 1)
        ...
        self.gridLayout.addWidget(self.ItemCount, 8, 5, 2, 1, QtCore.Qt.AlignHCenter|QtCore.Qt.AlignVCenter)
        ...
        Converty.setTabOrder(self.loadFolder, self.loadFile)
    ...
    def retranslateUi(self, Converty):
        ...
        self.comboBox.setItemText(3, _translate("Converty", "Greyscale"))
